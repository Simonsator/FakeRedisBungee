...
public class LimeworkFakeUnifiedJedis extends FakeJedis {
	private final UnifiedJedis SOURCE;

	public LimeworkFakeUnifiedJedis(UnifiedJedis pJedis) {
		SOURCE = pJedis;
	}
	...
	public FakeJedisTransaction multi() {
		return new LimeworkFakeUnifiedJedisTransaction(SOURCE.multi());
	}
